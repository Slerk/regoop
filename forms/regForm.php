        ...
        <div class="header">
            ...
            <div class="h_right">
                <ul class="menu">
                    ...
                    <li class="active"><a href="regForm.php">Регистрация</a></li>
                ...
                <div class="contact">
                    ...
                    <div class="contact_right">
                        <div class="contact-form">
                            <h3>Регистрация</h3>
                            <form method="post" action="../include/regPost.php">
                                <div>
                                ...
                                <div>
                                    ...
                                    <span><input type="email" class="form-control" id="email" name="email"></span>
                                </div>
                                <div>
                                ...
                                <div>
                                    <span> <button id="but_reg" name="but_reg" type="submit">Регистрация</button></span>
                                </div>
